<template>
    <div ref="16" id="inner" class="inner page page16">
        <div class="goleft">
            <svg
        ...
        <div class="body">
            ...
            <div class="paragraph">
                ...
                <div class="line">
                    <span>will collect & sort</span>
                </div>
                <div class="line">
                    the best recipes for
                </div>
                <div class="line">
                    your patient's plans.
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    mounted() {
        ...
        var mc = new Hammer.Manager(this.$refs['16'], {
            recognizers: [
                [
                    Hammer.Swipe,
                    {
    ...
    created() {
        this.$store.commit('updateCurrentPage', 16);
    }
};
</script>
